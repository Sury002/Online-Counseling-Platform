            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
              <div className="p-6 border-b border-gray-700">
                ...
                <textarea
                  ...
                  className="w-full h-64 p-4 bg-gray-900 border border-gray-700 rounded resize-none text-gray-100"
              ...
              <div className="p-4 bg-gray-800/50 flex justify-end">
                {saved && (
                  <span className="text-sm text-emerald-400 mr-4 flex items-center">
                    Saved successfully!
                  </span>
                )}
                <button
