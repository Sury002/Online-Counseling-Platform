              ...
              {selected.isPaid && selected.status === "pending" ? (
                <form onSubmit={sendMessage} className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    disabled={!text.trim()}
                    className="p-3 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full py-2 px-4 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
                  >
